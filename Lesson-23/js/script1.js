...
const str6 = ' Вибрати 2018 усі 2022 роки після 2021 року з 2023  отриманого 2015 2089 2589 3589 повідомлення'
const reg5 = /\b[2-9][0-9][2-9][2-9]\b/g
...
let reg8 = /(sat|sun|[5-6])/
let reg9 = /mon|tue|wed|thu|fri|[0-4]/
if(reg8.test(formUserDay)) console.log('Це вихідний день')
else if (reg9.test(formUserDay))
console.log('Це робочий день')
else 
throw new Error('Введіть день в потрібному форматі!')
